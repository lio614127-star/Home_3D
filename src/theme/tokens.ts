...
export const darkTheme: ThemeTokens = {
  ...
  selectionFill: 'rgba(56, 189, 248, 0.20)',
  selectedStroke: '#38bdf8',
  siteFill: 'rgba(45, 212, 191, 0.10)',
  siteStroke: '#2dd4bf',
  buildingFootprintStroke: '#fb923c',
  roomFill: 'rgba(96, 165, 250, 0.14)',
  roomStroke: '#94a3b8',
  roomText: '#f3f4f6',
  wallFill: '#888888',
  wallStroke: '#e5e7eb',
